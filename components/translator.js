...
translate(text, dict, titles, timeRegex, locale){
  ...
  const matchesMap = {};
  // Search for titles/honorifics and add 'em to the matchsMap object
  ...
  // Search for individual word matches and add 'em to the matchsMap object
